...
; Update 2014/07 pboerner : Added "6173" (HMI continuum) as a 10th wavelength,
; 	and silenced the loadct call
; Update 2015/01 pboerner : Added "0" (HMI B_LOS) as an 11th wavelength
; Sequel 2015/01 rtimmons : Made "1" the hack for HMI B_LOS, because 0
;makes it think 'keyword not set'
...
wave=[1600,1700,4500,94,131,171,193,211,304,335,6173,1]
...
10: begin  ; 6173 (HMI continuum)
   r=c0
   g=c0
   b=byte(b0/2)
   end
11: begin  ; 1 (HMI B_LOS)
   r=c0
   g=c0
   b=c0
   end
