...
def load_xrt(xrt_path, time, bl, tr, xrt_exclude=[], plot=True, method='First', exposure_dict=exposure_dict,
    ...
    if plot:
        if not os.path.exists('./xrt_images/'):
            os.makedirs('./xrt_images/')
        ...
        for w in filters:
            ...
            if len(files) >= 1 and method=='Average':
                ...
                for f in range(0, len(files)):
                    ...
                    filename_stem = './xrt_images/'+filename.split('.')[0]
    ...
    try:
        ...
        agr_path = '/Users/jessieduncan/dems/xrt_tresp_hissw_wrapper_aiaspec.pro'
