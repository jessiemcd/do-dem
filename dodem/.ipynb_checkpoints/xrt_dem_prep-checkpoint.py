...
def load_xrt(xrt_path, time, bl, tr, xrt_exclude=[], plot=True, method='First', exposure_dict=exposure_dict,
    ...
    #It used to be just datestring=time[0].value[0:10] – idk why it started breaking. But if it breaks again, maybe 
    #something to do with time formats.
    datestring=str(time[0].value)[0:10]
    #print(datestring)
